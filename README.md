...
## Использование
(os Windows10)<br />
Сервер (клиент аналогично) можно запустить как с помощью двойного щелчка по файлу Server.exe, так и с помощью консоли:<br />
`C:\SNTP\Server\bin\Release>Server.exe -o 10 -t 10000`<br />
Далее, сервер перейдет в режим ожидания клиентов.


## Автор
Чернущенко Денис Юрьевич, Март 2018.
